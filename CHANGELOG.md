...
- Added immutable, privacy-bounded action ledger shards for all six ClawSweeper action families, with strict JSON identity hashing, explicit mutation idempotency, no-follow writes, replay-stable run partitions, full producer binding, and deterministic causal ordering.
